  ...
  return (
    <div className="container mx-auto p-6 bg-white shadow-md rounded-lg mt-8">
            ...
            <tbody className="divide-y divide-gray-200">
              {trainingElements.map((element) => (
                <tr key={element.id} className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-6 whitespace-nowrap text-sm text-gray-700">{element.duration_minutes}</td>
                  <td className="py-3 px-6 whitespace-nowrap text-sm text-gray-700">{element.session_type}</td>
      ...
      <TrainingElementModal 
        ...
        onSaveSuccess={fetchTrainingElements} 
      />
    </div>
  );
}
